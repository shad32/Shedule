...
public class _5saturday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(xmlParser.checkExistFile()) {
            ...
            adapter = new CustomListAdapter(getActivity(), xmlParser.parseScheduleForDay("saturday", new UpdateCurrentWeek().parityOfWeek(getActivity())+""));
