...
public class _3thursday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(xmlParser.checkExistFile()) {
            ...
            adapter = new CustomListAdapter(getActivity(), xmlParser.parseScheduleForDay("thursday", new UpdateCurrentWeek().parityOfWeek(getActivity())+""));
