...
public class _2wednesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(xmlParser.checkExistFile()) {
            ...
            adapter = new CustomListAdapter(getActivity(), xmlParser.parseScheduleForDay("wednesday", new UpdateCurrentWeek().parityOfWeek(getActivity())+""));
