...
public class _1tuesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(xmlParser.checkExistFile()) {
            ...
            adapter = new CustomListAdapter(getActivity(), xmlParser.parseScheduleForDay("tuesday",new UpdateCurrentWeek().parityOfWeek(getActivity())+""));
